...
TEdgeSegment::TEdgeSegment(TCollisionComponent *collComp, char *activeFlag,
                           unsigned collisionGroup) {
...
TEdgeSegment *
TEdgeSegment::install_wall(float *floatArr, TCollisionComponent *collComp, char *activeFlagPtr,
            ...
            for (int index = 0; index < wallTypeI; index++, floatArrPtr += 2) {
                ...
                if (offset != 0.0f) {
                    ...
                    if ((dstVec.Z > 0.0f && offset > 0.0f) ||
                        ...
                        auto circle = new TCircle(collComp, activeFlagPtr, collisionGroup, &center,
                                                  radius);
